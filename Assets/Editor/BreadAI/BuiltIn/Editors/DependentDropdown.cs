...
[CustomPropertyDrawer(typeof(CompoundDependentDropdownAttribute))]
public class DependentDropdown : PropertyDrawer
{
    ...
    {
        var attributeData = attribute as CompoundDependentDropdownAttribute;
