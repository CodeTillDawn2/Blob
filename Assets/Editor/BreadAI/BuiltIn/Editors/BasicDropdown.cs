...
public class BasicDropdown : PropertyDrawer
{
    ...
    private void Initialize(SerializedProperty property)
    {
        ...
        if (AIBakerData.Instance.BreadValidConfigurations.TryGetValue(attributeData.Key, out var primaryDict))
        {
            dataError = false;
    ...
    {
        if (AIBakerData.Instance.BreadValidConfigurations.ContainsKey(baseType) && AIBakerData.Instance.BreadValidConfigurations[baseType].TryGetValue(primaryTypeSelection, out var configs))
        {
