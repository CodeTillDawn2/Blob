...
public class BasicDropdown : PropertyDrawer
{
    ...
    {
        if (AIEditorBaker.CharacterSystemToConfigMapping.ContainsKey(baseType) && AIBakerData.instance.CharacterSystemToConfigMapping[baseType].TryGetValue(primaryTypeSelection, out var configs))
        {
