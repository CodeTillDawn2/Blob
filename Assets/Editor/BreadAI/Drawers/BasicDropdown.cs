...
public class BasicDropdown : PropertyDrawer
{
    ...
    {
        if (AIEditorBaker.SystemToConfigMapping.ContainsKey(baseType) && AIBakerData.instance.CharacterSystemToConfigMapping[baseType].TryGetValue(primaryTypeSelection, out var configs))
        {
