...
public static class AIEditorBaker
{
    ...
    public static void BakeAI()
    {
        ...
        WriteToDisk<Dictionary<string, ScriptableObject>>(AllConfigInstances, AllConfigInstances_Path);
        CharacterSystemToConfigMapping = BakeCharacterSystemsToConfigMappings();
        WriteToDisk<Dictionary<string, Dictionary<string, List<string>>>>(CharacterSystemToConfigMapping, CharacterSystemToConfigMapping_Path);
